        ...
        if (action == MotionEvent.ACTION_UP || action == MotionEvent.ACTION_POINTER_UP || action == MotionEvent.ACTION_CANCEL) {
            ...
            if (longClickGesture) {
                queueEvent(()->{
                    ...
                    requestRender();
                    Santoku.EVENT_BUS.fireEvent(new LongClickTranslationEvent(longClickTranslation.x, longClickTranslation.y, false));
                });
            }
            longClickGesture = false;
            if (fromTwoPointers) {
                    ...
                    if (!startingGesture) {
                        if (longClickGesture) {
                            ...
                            if (!longClickHitResults.isEmpty()) {
                                ...
                                Santoku.EVENT_BUS.fireEvent(new LongClickTranslationEvent(longClickTranslation.x, longClickTranslation.y, true));
                            }
